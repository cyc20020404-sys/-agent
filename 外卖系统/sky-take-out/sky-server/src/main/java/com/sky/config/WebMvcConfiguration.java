...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        //位于knife4j-spring-ui-3.0.2.jar 下的META-INF/resources/
        //将 URL 路径 /doc.html 映射到 classpath 中的 /META-INF/resources/ 目录
        registry.addResourceHandler("/doc.html").addResourceLocations("classpath:/META-INF/resources/");
        //将 URL 路径 /webjars/** 映射到 classpath 中的 /META-INF/resources/webjars/ 目录
        registry.addResourceHandler("/webjars/**").addResourceLocations("classpath:/META-INF/resources/webjars/");

        //图片上传 存放位置
        String uploadPath = localOssProperties.getUploadPath();
        // 确保路径以 "/" 结尾
        ...
        // 映射根路径下的图片文件（png, jpg, jpeg, gif等）到上传路径
//        registry.addResourceHandler("/**.png", "/**.jpg", "/**.jpeg", "/**.gif", "/**.bmp", "/**.webp").addResourceLocations("file:" + uploadPath);
    }
}
